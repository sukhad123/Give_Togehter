          ...
          <div className="w-full md:w-1/2 lg:w-2/5">
            <div className="space-y-4">
              {socialLinks.map((link) => (
                <a key={link.name} href="#" className={`${link.bgColor} flex items-center justify-center text-white font-bold py-4 px-6 rounded-full text-lg w-full transition-transform transform hover:scale-105`}>
                  {link.icon}
